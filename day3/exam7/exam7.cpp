...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	{//버튼생성
		CreateWindow(L"button", L"click Me",WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
			20,20,100,25,hWnd,(HMENU)3001,hInst,NULL); //3001은 안 겹칠것 같은 숫자를 암거나 쓴 것.

		CreateWindow(L"button", L"click Me 2", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
			20, 50, 100, 25, hWnd, (HMENU)3002, hInst, NULL); //3001은 안 겹칠것 같은 숫자를 암거나 쓴 것.
    ...
    case WM_COMMAND:
        {
			...
			case 3002:
			{
				MessageBox(hWnd, L"Second Button Click!!", L"Button\n", MB_OK); //메세지 박스 팝업
			}
			break;
            default:
