    ...
    case WM_PAINT:
        {
			...
			//2번째줄
			SetPixel(hdc, 105, 101, RGB(255, 0, 0));
			SetPixel(hdc, 105, 102, RGB(255, 0, 0));
			SetPixel(hdc, 105, 103, RGB(255, 0, 0));
			SetPixel(hdc, 105, 104, RGB(255, 0, 0));
			SetPixel(hdc, 105, 105, RGB(255, 0, 0));

			//3번째줄
			SetPixel(hdc, 104, 105, RGB(255, 0, 0));
			SetPixel(hdc, 103, 105, RGB(255, 0, 0));
			SetPixel(hdc, 102, 105, RGB(255, 0, 0));
			SetPixel(hdc, 101, 105, RGB(255, 0, 0));
