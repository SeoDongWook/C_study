    ...
    case WM_PAINT:
        {
			...
			plusEngine::printf(&grp, line1.end.X, line1.end.Y, L"(%.1f,%.1f)", line1.end, line1.end.Y);
			...
			irr::core::vector2df coIPt;
			if(line1.intersectWith(line2, coIPt)) {
				plusEngine::printf(&grp, coIPt.X, coIPt.Y, L"(%.1f,%.1f)", coIPt.X, coIPt.Y);
				grp.DrawRectangle(&pen, coIPt.X - 4, coIPt.Y - 4, 8., 8.);
			}
			else {
				}
			grp.ResetTransform();
