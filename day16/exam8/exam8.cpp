...
//
//
REAL g_fAngle, g_fAngle2; //바디앵글, 포탑앵글
    ...
    case WM_PAINT:
        {
			...
			//탱크 그리기
			{
				...
				//body
				grp.DrawRectangle(&pen, -20, -30, 40, 60); //몸통
				grp.DrawRectangle(&pen, -20, -30, 40, 10);
				
				grp.RotateTransform(g_fAngle2); //바디회전.
				//head
				grp.DrawRectangle(&pen, -3, -50, 6, 40);   //포대
				grp.DrawRectangle(&pen, -10, -10, 20, 20); //포탑
				

				grp.SetTransform(&oldMat); //포탑회전.
