    ...
    case WM_PAINT:
        {
			...
			FontFamily fontfamGulim(L"굴림"); //폰트로더
			Font fontGulim(&fontfamGulim, 12, FontStyleRegular, UnitPixel); //&는 포인터 함수(?)

			SolidBrush brushBlue(Color(0, 0, 255)); //브러시 만들기
			SolidBrush brushBlack(Color(0, 0, 0));

			graphics.DrawString(L"안녕하세요",-1,&fontGulim,PointF(100,100),&brushBlue); //-1은 글자수 알아서 세주는거
			graphics.DrawString(L"안녕하세요", -1, &fontGulim, PointF(100, 100+24), &brushBlack);
